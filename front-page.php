        ...
        <div class="container">
            ...
            <div class="c-project__list">
                <div class="c-project__item">
                    <a href="#" class="c-project__link">
                        <div class="c-project__image">
                            <img src="../dist/images/img_project.jpg" alt="">
                            <span class="c-project__image-number">7</span>
                        </div>
                        <div class="c-project__info">
                            <p class="c-project__cate">Căn hộ</p>
                            <p class="c-project__title">Cho thuê căn hộ ccmn siêu đẹp full nội thất cao cấp đầy đủ tiện</p>
                            <p class="c-project__address">Cầu Giấy, Hà Nội</p>
                            <ul class="c-project__ultity">
                                <li class="c-project__ultity-item">
                                    <span class="c-project__ultity-title">Diện tích</span>
                                    <span class="c-project__ultity-info">50 m²</span>
                                </li>
                                <li class="c-project__ultity-item">
                                    <span class="c-project__ultity-title">Số phòng ngủ</span>
                                    <span class="c-project__ultity-info">1 phòng</span>
                                </li>
                                <li class="c-project__ultity-item">
                                    <span class="c-project__ultity-title">Mức giá</span>
                                    <span class="c-project__ultity-info">7 triệu/tháng</span>
                                </li>
                            </ul>
                            <div class="c-project__footer">
                                <p class="c-project__time">Hôm nay</p>
