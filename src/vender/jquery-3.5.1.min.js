!(function (e, t) {
    ...
    (b.event = {
        ...
        dispatch: function (e) {
            var t,
                ...
                u = b.event.fix(e),
                l =
                    (G.get(this, 'events') || Object.create(null))[u.type] ||
                    [],
    ...
    function Oe(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Y.hasData(e) &&
                ((o = Y.access(e)), (a = b.extend({}, o)), Y.set(t, a));
        }
    }
    function Pe(e, t, n, r) {
        t = o(t);
        ...
        if (
            ...
            if (u)
                for (
                    c = s[s.length - 1].ownerDocument, b.map(s, He), f = 0;
                    f < u;
                    f++
                )
                    (l = s[f]),
        ...
        b.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType &&
                        (b.cleanData(ve(e, !1)), (e.textContent = ''));
                return this;
            },
            clone: function (e, t) {
                return (
                    ...
                    i ||
                        ...
                        (l &&
                            ...
                            t.isPropagationStopped() &&
                                d.addEventListener(m, xt),
                            r[m](),
                            t.isPropagationStopped() &&
                                d.removeEventListener(m, xt),
        ...
        b.extend({
            ...
            ajax: function (t, n) {
                ...
                d.ifModified &&
                    ...
                    b.etag[i] &&
                        E.setRequestHeader('If-None-Match', b.etag[i])),
